...
const Step4 = forwardRef<HTMLDivElement, Step4Props>(({ register, errors, isValid, onSubmit, onPrev, onClose, isAnimating }, ref) => {
  return (
    <div
      ref={ref}
      className="p-6 flex flex-col items-center justify-between min-w-[491px] min-h-[100px] bg-[#121212] border border-emerald-300 rounded-2xl fixed bottom-3 left-1/2 transform -translate-x-1/2"
    >
      <div className="flex flex-col gap-6 w-full">
        ...
        <div className="flex flex-col gap-3 2xl:gap-6 w-full">

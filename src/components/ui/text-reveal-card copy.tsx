...
// export const TextRevealCard = ({ text, revealText, children, className, threshold = 0.3, duration = 1.5 }: TextRevealCardProps) => {
...
//         <p className="font-bold text-[60px] x320:text-[80px] md:text-[100px] 2xl:text-[156px] whitespace-nowrap opacity-0 pointer-events-none">{revealText.length > text.length ? revealText : text}</p>
...
//             }}
//             className="font-bold text-[#6EE7B7] bg-clip-text text-[60px] x320:text-[80px] md:text-[100px] 2xl:text-[156px] bg-gradient-to-b from-white to-neutral-300 whitespace-nowrap"
//           >
//             {revealText}
//           </p>
//         </motion.div>
...
//             width: `${4 + revealPercentage / 10}px`
//           }}
...
//           <p
//             className="font-bold bg-clip-text text-[60px] x320:text-[80px] md:text-[100px] 2xl:text-[156px] text-transparent bg-[#323238] whitespace-nowrap"
//             style={{

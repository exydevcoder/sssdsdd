...
export default function LiquidGlitchImage({
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          // Only apply effects when hovered
          if (uHover > 0.1) {
            // Distance from mouse
            ...
            // When not hovered, just display the normal texture
    ...
    const animate = () => {
      ...
      // Update uniforms - set all effects to 0 when not hovered
      ...
      material.uniforms.uNoiseStrength.value = THREE.MathUtils.lerp(
        ...
        isHovered ? 1.0 : 0.0,  // Changed from 0.2 to 0.0
        0.03
      );
